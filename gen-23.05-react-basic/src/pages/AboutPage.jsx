          ...
          <div className='flex justify-center containerLeft md:flex-content'>
            <div className='m-3 content'>
              ...
              <div className='flex max-w-md m-1 mt-1 overflow-auto'>
                <img
                  src={getImgUrl('/images/2.webp')}
                  className='w-24 mr-2 transition cursor-pointer flex-flexGellery hover:opacity-50'
                  alt='Product 1'
                />
                <img
                  src={getImgUrl('/images/3.webp')}
                  className='w-24 mr-2 transition cursor-pointer flex-flexGellery hover:opacity-50'
                  alt='Product 2'
                />
                <img
                  src={getImgUrl('/images/4.webp')}
                  className='w-24 mr-2 transition cursor-pointer flex-flexGellery hover:opacity-50'
                  alt='Product 3'
                />
                <img
                  src={getImgUrl('/images/5.webp')}
                  className='w-24 mr-2 transition cursor-pointer flex-flexGellery hover:opacity-50'
                  alt='Product 4'
                />
                <img
                  src={getImgUrl('/images/6.webp')}
                  className='w-24 mr-2 transition cursor-pointer flex-flexGellery hover:opacity-50'
                  alt='Product 5'
                />
              </div>
